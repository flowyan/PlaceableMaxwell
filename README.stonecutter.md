...
|--------------------|----------------------------------------------|-------------------------------------------------------------------|
| `mod.id`           | Your mod's identifier (lowercase, no spaces) | `DimensionFollow`                                                     |
...
Rename the `dev.flwn.dimensionfollow` package in
...
* `src/main/resources/DimensionFollow.mixins.json`
...
* **Shared code** goes in `dev.flwn.dimensionfollow` (no platform dependencies)
* **Platform-specific code** goes in `dev.flwn.dimensionfollow.platform.{fabric|neoforge|forge}`
